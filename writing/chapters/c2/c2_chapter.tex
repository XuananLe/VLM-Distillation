...
Figure~\ref{fig:prelim-optimal-transport} shows the transport-plan view behind
mass matching. Figure~\ref{fig:prelim-uld-schematic} translates that view into
...
\begin{figure}[htbp]
    ...
    \end{tikzpicture}
    \caption{ULD compares ranked probability mass after temperature scaling, sorting and zero-padding to a common vocabulary length \cite{boizard2024towardscrosstokenizerdistillation}. This is why the loss stays valid even when teacher and student vocabularies differ.}
