...
\newcommand{\gracefull}{Gradient-Routed Alignment with Cross-tokenizer Experts}
...
\hypersetup{
  pdftitle={Gradient-Routed Alignment with Cross-tokenizer Experts for Multimodal Understanding},
