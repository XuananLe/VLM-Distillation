...
# Loss = ce_loss + alpha * kd_loss + teacher_gate_regularizers
ALPHA="${ALPHA:-0.5}"
TEACHER_WEIGHTING_STRATEGY="routing"
...
RUN_TAG="${RUN_TAG:-routing_${DATASET_NAME}_${LOSS_TAG}_topk${TEACHER_GATE_TOP_K}_gracewarm${GRACE_WARMUP_RATIO//./p}_$(date +%Y%m%d_%H%M)}"
