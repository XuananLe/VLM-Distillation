...
# InternVL checkpoints still need model-side compatibility patches under
# Transformers 5.x; upstream discussions track why this cannot be fixed fully
# from the generic Transformers loader alone.
# https://github.com/OpenGVLab/InternVL/issues/1031
